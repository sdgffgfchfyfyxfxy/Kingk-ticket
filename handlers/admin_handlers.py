...
from keyboards.keyboards import admin_panel_keyboard, admin_ticket_action_keyboard, main_menu_keyboard
...
async def admin_send_reply_content(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ارسال به کاربر
    bot = context.bot
    prefix = f"🛠 [پاسخ ادمین به تیکت #{ticket_id}]:\n"
    full_cap = prefix + caption
...
async def user_reply_new_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # این حالت به صورت هندلر عمومی متن/فایل مدیریت می‌شود
