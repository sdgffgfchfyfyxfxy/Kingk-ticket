...
from handlers.user_handlers import (
    ...
    my_tickets_handler, view_ticket_handler
)
...
async def user_active_ticket_message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from database.db import add_ticket_message
...
def main():
    ...
    # Conversation Handler برای ساخت تیکت
    ticket_conv_handler = ConversationHandler(
        ...
        states={
            ...
            TicketStates.CONTENT: [
                MessageHandler((filters.TEXT | filters.PHOTO | filters.VIDEO | filters.VOICE | filters.DOCUMENT) & ~filters.COMMAND, receive_ticket_content),
    ...
    # Conversation Handler برای پاسخ ادمین
    ...
    # Conversation Handler برای پیام همگانی ادمین
